...
UUID=${UUID:-'f52f1f11-3079-415e-94c1-83950ea176c1'}
VMESS_WSPATH=${VMESS_WSPATH:-'/vmstackblitz'}
VLESS_WSPATH=${VLESS_WSPATH:-'/vlstackblitz'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/trstackblitz'}
SS_WSPATH=${SS_WSPATH:-'/ssstackblitz'}
